...
class Snippet extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\AbstractRenderer
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $html = '<div class="magicslider-snippet"><input class="copy-input" type="hidden" value="' . $shortcodeWidget . '" readonly><button style="display: inline-flex;" class="copy-to-clipboard action-default scalable add primary">' . __('Copy to Widget') . $iconSvg . '</button></div>';
        // $html .= '<div class="magicslider-snippet"><input class="copy-input" type="hidden" value="' . $shortcodeBlock . '" readonly><button style="display: inline-flex;" class="copy-to-clipboard action-default scalable add primary">' . __('Copy to Phtml') . $iconSvg . '</button></div>';
